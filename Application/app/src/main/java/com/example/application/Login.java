    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        goToRegister.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent =new Intent(com.example.application.Login.this,MainActivity.class);
                ...
                fAuth.signInWithEmailAndPassword(m1email, m1password).addOnCompleteListener(new OnCompleteListener<AuthResult>() {
                    ...
                    public void onComplete(@NonNull Task<AuthResult> task) {
                        if (task.isSuccessful()) {
                            Toast.makeText(com.example.application.Login.this, "Successfully logged in", Toast.LENGTH_SHORT).show();
                            //redirect to next page
                        } else {
                            Toast.makeText(com.example.application.Login.this, "error" + task.getException(), Toast.LENGTH_SHORT).show();
                        }
                    }
